...
from src.email_auto.models import EmailDetails, SimpleCategorizedEmail, OrganizedEmail, EmailResponse, \
    EmailCleanupInfo

from src.email_auto.tools.custom_tool import GetUnreadEmailsTool, OutlookOrganizeTool, SaveDraftTool, OutlookDeleteTool, EmptyTrashTool
...
class EmailAuto():
    ...
    def organizer(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[OutlookOrganizeTool(), FileReadTool()],
            llm=self.llm,
        )
    ...
    def cleaner(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[OutlookDeleteTool(), EmptyTrashTool()],
            llm=self.llm,
        )
    ...
    def organization_task(self) -> Task:
        ...
        return Task(
            ...
            output_pydantic=OrganizedEmail, # force structure
        )
    ...
    def _validate_categorization_output(self, output):
        ...
        if isinstance(output, dict):
            ...
            #         function_call = {'name': list(function_call.keys())[0],
            #                          'arguments': function_call[list(function_call.keys())[0]]}
